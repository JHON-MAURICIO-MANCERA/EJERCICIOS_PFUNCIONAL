...
//========================================================================================
	...
	Flowable<User> fromFluxToFlowable(Flux<User> flux) {
		return fluxToFlowable(flux);
	}

	// TODO Adapt RxJava Flowable to Flux
	Flux<User> fromFlowableToFlux(Flowable<User> flowable) {
		return flowableToFlux(flowable);
	}
...
//========================================================================================
	...
	Observable<User> fromFluxToObservable(Flux<User> flux) {
		return fluxToObservable(flux);
	}//la clase OBSERVABLE emite un flujo de datos o eventos.
    //subscriber,https://programacionymas.com/blog/introduccion-rx-java-tutorial-android
...
//========================================================================================
	...
	Single<User> fromMonoToSingle(Mono<User> mono) {
		return monoToSingle(mono);
	}

	// TODO Adapt RxJava Single to Mono
	Mono<User> fromSingleToMono(Single<User> single) {
		return singleToMono(single);
	}
